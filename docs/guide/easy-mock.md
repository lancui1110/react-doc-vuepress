...
文档路径：[Easy Mock](https://easy-mock.com/docs)
...
![演示项目](../assets/easy-mock-images/demo.png)
...
![创建项目/第一步](../assets/easy-mock-images/create-project.png)
...
![创建项目/第三步](../assets/easy-mock-images/create-mock.png)

**最后一步：预览接口**

每个接口旁边都会对应很多操作按钮。现在点击红框标注的 **预览按钮**，看看会发生什么事情吧！

![创建项目/最后一步](../assets/easy-mock-images/preview.png)
...
![petstore](../assets/easy-mock-images/petstore.png)

由于版本问题，也许你会看到这样的文档首页。不要紧，复制如下地址即可。

![swagger-home](../assets/easy-mock-images/swagger-home.png)
...
![response](../assets/easy-mock-images/response.png)
...
如果生成数据的时间 **超过 1s**，系统将会返回一个 **timed out** 的错误信息，此时应该检查代码是否出现了 **异步操作** 或 **死循环**。
